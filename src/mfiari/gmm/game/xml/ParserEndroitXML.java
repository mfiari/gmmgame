 ...
 */
package mfiari.gmm.game.xml;

import mfiari.gmm.game.objet.TypeObjet;
import mfiari.gmm.game.ville.Batiment;
import mfiari.gmm.game.ville.Endroit;
import mfiari.gmm.game.ville.Maison;
...
public class ParserEndroitXML extends DefaultHandler {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("endroit")) {
            ...
            if ("maison".equals(typeBatiment)) {
                Maison maison = new Maison("maison", positionx, positiony, 1, 1, 1);
                this.quartier.ajouterBatiment(maison);
            } else if ("labo".equals(typeBatiment)) {
                Batiment labo = new Batiment("Labo du prof", positionx, positiony, 1, 1, 0, 1);
    ...
    private TypeObjet getTypeObjetByTypeName (String type) {
        switch (type) {
            case "chemin":
                return TypeObjet.chemin;
            case "arbre":
